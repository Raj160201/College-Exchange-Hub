            ...
            <div className="container-content" data-aos="fade-up">
                <div class="compalinace-content">
                    <div class="content-container">
                        ...
                        <p class="updated-date">Last updated on Jan 3rd 2024</p>
                        <p class="content-text">
                            This privacy policy sets out how <b>Cravee</b> uses and protects any information that you give <b>Cravee</b> when you use this website.
                        </p>
                        <p class="content-text">
                            <b>Cravee</b> is committed to ensuring that your
                        ...
                        <p class="content-text">
                            <b>Cravee</b> may change this policy from time
                        ...
                        <ul class="unorder-list">
                            <li class="list-item">
                                <p class="content-text list-text">Name</p>
                            </li>
                            <li class="list-item">
