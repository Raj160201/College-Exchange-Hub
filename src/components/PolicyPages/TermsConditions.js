                ...
                <div class="compalinace-content">
                    <div class="content-container">
                        ...
                        <p class="content-text">
                            ...
                            "our" used anywhere on this page shall mean <b>Cravee</b>, whose registered/operational
                            office is
                            At:- Pokhraira, Post Office:- Pokhraira
                            Samastipur
                            Bihar India
                            848113
                        ...
                        <ul class="unorder-list">
                            ...
                            <li class="list-item">
                                <p class="content-text list-text">
                                    You may not create a link to our website from another website or document without <b>Cravee</b>’s prior written consent.
                                </p>
                            </li>
                            <li class="list-item">
                                <p class="content-text list-text">
